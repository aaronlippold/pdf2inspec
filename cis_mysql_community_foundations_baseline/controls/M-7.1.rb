control "M-7.1" do
  title "7.1 Ensure Passwords Are Not Stored in the Global Configuration
(Scored)"
...
steps:
 ...
 Examine the [client] section of the MySQL configuration
file and ensure password
is not employed.
"
  tag "fix": "Use the mysql_config_editor to store authentication credentials
in .mylogin.cnf in
encrypted form.
