...
unique time bounded lifetime.  Allows additional security factors pertinent to
a specific user to provide further password security; predetermined by varying
...
"
  tag "fix": "Using the user and host information from the audit procedure,
set each user a password
lifetime e.g.
