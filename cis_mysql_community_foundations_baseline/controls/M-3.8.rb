...
Then, execute the following command at a terminal
prompt (using the discovered
...
"
  tag "fix": "To remediate this setting, execute the following commands
at a terminal prompt using the
