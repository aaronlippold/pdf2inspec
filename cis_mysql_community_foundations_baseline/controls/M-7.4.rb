...
https://dev.mysql.com/doc/refman/5.7/en/password-­‐expiration-­‐sandbox-­‐
mode.html"
  tag "severity": "medium"
  tag "cis_id": "7.4"
...
SHOW VARIABLES LIKE 'default_password_lifetime'; default_password_lifetime
should be less than or equal to 90.
"
  tag "fix": "Level 1 MySQL RDBMS: global policy
SET GLOBAL default_password_lifetime=90 and in the configuration file:
default_password_lifetime=90 As part of Installation and Planning consider set
an expiry policy for specific users. Doing
